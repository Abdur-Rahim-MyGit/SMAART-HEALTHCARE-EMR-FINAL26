...
const ClinicEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate date range (must be at least 1 year) - only if both dates are provided
    if (form.validityStartDate && form.validityEndDate) {
      ...
      // Allow start date to be in the past for existing clinics (don't restrict it)
    }
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate("/clinics", { state: { refresh: true, timestamp: Date.now() } });
      } else {
  ...
  return (
    <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Edit Clinic</h1>
          <p className="text-gray-600 dark:text-gray-400">
            Update clinic information and settings
          </p>
        </div>

        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-8 border border-gray-100">
          <form onSubmit={handleSubmit}>
            {/* Basic Information */}
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4 border-b border-gray-200 dark:border dark:border-gray-800 pb-2">
              Basic Information
            </h3>
            ...
            {/* Contact & Location */}
            <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4 border-b border-gray-200 dark:border dark:border-gray-800 pb-2 mt-6">
              Contact & Location
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    className={`w-full px-3 py-2 bg-white dark:bg-gray-950 dark:text-white border border-gray-300 dark:border-gray-700 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-10 ${
            ...
            <div className="mb-6 p-4 border border-gray-200 dark:border dark:border-gray-800 rounded-lg bg-gray-50 dark:bg-gray-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (value && form.validityDurationMonths) {
                        ...
                        setFormErrors(prev => {
                          ...
                          delete newErrors.validityEndDate;
                          delete newErrors.validityDurationMonths;
                          return newErrors;
                        });
                      }
                    }}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      if (form.validityStartDate && value) {
                        const startDate = new Date(form.validityStartDate);
                        const endDate = new Date(startDate);
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (form.validityStartDate && value) {
                        ...
                        // Update duration based on end date
                        const closestDuration = diffMonths <= 18 ? '12' : 
                                              diffMonths <= 30 ? '24' : 
                                              diffMonths <= 42 ? '36' : 
                                              diffMonths <= 54 ? '48' : '60';
                        ...
                        setForm((prev) => ({
                          ...
                          validityDurationMonths: closestDuration,
                        }));
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Editable - Duration will auto-adjust based on dates
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-4 mt-8">
              <button
                type="submit"
                className="bg-gray-600 hover:bg-gray-700 text-white dark:text-gray-100 px-8 py-3 rounded-xl transition-colors flex-1"
                disabled={saving}
              >
              ...
              <button
                ...
                className="bg-gray-500 hover:bg-gray-600 text-white dark:text-gray-100 px-8 py-3 rounded-xl transition-colors"
              >
                Cancel
              </button>
            </div>
