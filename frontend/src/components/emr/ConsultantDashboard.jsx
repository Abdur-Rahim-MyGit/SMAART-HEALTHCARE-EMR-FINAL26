  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">EMR - Consultant Dashboard</h1>
          <p className="text-gray-600 dark:text-gray-400">Electronic Medical Records & Consultation Management</p>
        </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">{session.consultationType}</p>
        ...
        <div className="lg:col-span-3">
          {selectedSession ? (
            <div className="space-y-6">
              ...
              {/* Navigation Tabs */}
              <div className="card dark:bg-gray-950 dark:border dark:border-gray-800">
                <div className="border-b border-gray-200 dark:border dark:border-gray-800">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-black p-3 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        ...
                        <div key={index} className="bg-gray-50 dark:bg-black p-4 rounded-lg">
                          ...
                          <p className="text-2xl font-bold text-gray-900 dark:text-white">{vital.value}</p>
                          <p className="text-sm text-gray-500 dark:text-gray-400">{vital.unit}</p>
                        </div>
                      ))}
                    </div>
                  )}
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {selectedSession.assessment?.secondaryDiagnoses?.map((diagnosis, index) => (
                            <div key={index} className="bg-gray-50 dark:bg-black p-3 rounded-lg">
                              {diagnosis}
                            </div>
                          )) || <p className="text-gray-500 dark:text-gray-400">No secondary diagnoses recorded</p>}
                        </div>
                      </div>
                    </div>
                  )}
                            ...
                            <div key={index} className="bg-gray-50 dark:bg-black p-4 rounded-lg">
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  {med.duration && (
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Duration: {med.duration}</p>
                                  )}
                                </div>
            ...
            <div className="card dark:bg-gray-950 dark:border dark:border-gray-800 text-center py-12">
              <FileText className="h-12 w-12 text-gray-400 mx-auto mb-4" />
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No Session Selected</h3>
              <p className="text-gray-500 dark:text-gray-400">Select a consultation session from the sidebar to view details</p>
            </div>
          )}
        </div>
      </div>
