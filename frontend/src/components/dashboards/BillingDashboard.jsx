          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-black rounded-lg">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">PAT001234 - Consultation</p>
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-black rounded-lg">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">PAT001235 - Lab Tests</p>
