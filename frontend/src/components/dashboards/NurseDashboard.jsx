    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-6 border border-gray-100">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Patient care and clinical support</p>
          </div>
          
          {/* Clinic Information */}
          {dashboardData.clinicInfo && (
            <div className="bg-gradient-to-r from-[#004D99] to-[#42A89B] rounded-lg p-4 text-white dark:text-gray-100">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-white dark:bg-gray-950/20 rounded-lg flex items-center justify-center">
                  <Building2 className="h-5 w-5 text-white dark:text-gray-100" />
                </div>
                <div>
                  <h3 className="font-semibold text-lg">{dashboardData.clinicInfo.name}</h3>
                  <div className="flex items-center text-sm text-white dark:text-gray-100/80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="space-y-3">
            {dashboardData.nurses.slice(0, 5).map((nurse, index) => (
              <div key={index} className="flex items-center p-3 bg-gray-50 dark:bg-black rounded-lg">
                <div className="w-10 h-10 bg-gradient-to-r from-[#004D99] to-[#42A89B] rounded-full flex items-center justify-center text-white dark:text-gray-100 font-semibold text-sm">
            ...
            {dashboardData.nurses.length === 0 && (
              <p className="text-gray-500 dark:text-gray-400 text-sm text-center py-4">No nurses found</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="space-y-3">
            <div className="flex items-center p-3 bg-gray-50 dark:bg-black rounded-lg">
              <Activity className="h-5 w-5 text-[#004D99] mr-3" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Record vital signs for Ward A</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">8 patients remaining</p>
              </div>
            </div>
            <div className="flex items-center p-3 bg-gray-50 dark:bg-black rounded-lg">
              <Heart className="h-5 w-5 text-red-500 mr-3" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Medication rounds</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Due in 30 minutes</p>
              </div>
            </div>
            <div className="flex items-center p-3 bg-gray-50 dark:bg-black rounded-lg">
              <Calendar className="h-5 w-5 text-blue-500 mr-3" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Patient assessments</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">5 pending reviews</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-6 border border-gray-100">
          ...
          <div className="space-y-2">
            <button className="w-full bg-gradient-to-r from-[#004D99] to-[#42A89B] text-white dark:text-gray-100 py-2 px-4 rounded-lg text-sm font-medium hover:from-[#003d80] hover:to-[#3a7d92] transition-all flex items-center justify-center">
              <Activity className="h-4 w-4 mr-2" />
              Record Vitals
            </button>
            <button className="w-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 py-2 px-4 rounded-lg text-sm font-medium hover:bg-gray-200 dark:hover:bg-gray-800 transition-all flex items-center justify-center">
