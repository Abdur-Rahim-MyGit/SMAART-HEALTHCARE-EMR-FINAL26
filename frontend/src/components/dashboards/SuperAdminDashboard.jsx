...
const SuperAdminDashboard = () => {
  ...
  const StatCard = ({ title, value, icon: Icon, color }) => (
    <div className="bg-white dark:bg-gray-950 rounded-2xl shadow-soft border border-gray-100 p-5 hover:shadow-card dark:border-gray-800 hover:-translate-y-0.5 transition-all duration-200">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          ...
          <p className="text-[22px] leading-tight font-bold text-gray-900 dark:text-white">
            {loading ? '…' : value}
          </p>
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Manage your clinic operations efficiently</p>
        </div>
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="bg-white/80 backdrop-blur text-gray-700 dark:text-gray-300 py-2 px-4 rounded-lg text-sm font-medium hover:bg-white dark:hover:bg-gray-900 dark:bg-gray-950 transition-all flex items-center shadow-sm border border-gray-200 dark:border-gray-800"
          >
          ...
          <div className="relative export-dropdown">
            <button
              ...
              className="bg-white/80 backdrop-blur text-gray-700 dark:text-gray-300 py-2 px-4 rounded-lg text-sm font-medium hover:bg-white dark:hover:bg-gray-900 dark:bg-gray-950 transition-all flex items-center shadow-sm border border-gray-200 dark:border-gray-800 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isExporting ? (
            ...
            {showExportDropdown && (
              <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-950 rounded-lg shadow-lg dark:shadow-gray-900 border border-gray-200 dark:border-gray-800 z-50">
                <div className="py-2">
          ...
          <div className="flex items-center space-x-2 bg-white dark:bg-gray-950/80 backdrop-blur px-3 py-2 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="card dark:bg-gray-950 dark:border-gray-800">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Clinic Overview</h3>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Pending Appointments</span>
            ...
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Clinic Status</span>
          ...
          <div className="space-y-3">
            {recentAppointments.length > 0 ? (
              recentAppointments.map((appointment, index) => (
                <div key={index} className="flex items-center space-x-3 p-2 bg-gray-50 dark:bg-black rounded-lg">
