  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">Your healthcare information at a glance</p>
      </div>
        ...
        <div className="card dark:bg-gray-950 dark:border dark:border-gray-800">
          ...
          <div className="space-y-3">
            <div className="flex items-center p-3 bg-gray-50 dark:bg-black rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Dr. Smith - Cardiology</p>
            ...
            <div className="flex items-center p-3 bg-gray-50 dark:bg-black rounded-lg">
              <Calendar className="h-5 w-5 text-primary-500 mr-3" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-white">Dr. Johnson - Follow-up</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">Friday at 2:30 PM</p>
              </div>
            </div>
          </div>
        </div>
