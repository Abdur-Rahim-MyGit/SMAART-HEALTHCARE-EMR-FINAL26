...
const StaffManagement = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      default: return 'bg-gray-100 dark:bg-gray-900 text-gray-800'
    }
  }
  ...
  const getRoleColor = (role) => {
    switch (role) {
      ...
      case 'receptionist': return 'text-gray-600 dark:text-gray-400'
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
          <Users className="h-8 w-8 mr-3 text-gray-700 dark:text-gray-300" />
          Staff Management
        </h1>
        <p className="text-gray-600 dark:text-gray-400">Manage hospital staff and user administration</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg p-6 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Doctors</p>
        ...
        <div className="flex items-center space-x-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-700 rounded-md focus:ring-1 focus:ring-gray-500 focus:border-gray-500"
            />
          </div>
          <select
            value={filterRole}
            onChange={(e) => setFilterRole(e.target.value)}
            className="px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-md focus:ring-1 focus:ring-gray-500 focus:border-gray-500"
          >
          ...
          <button className="bg-gray-900 text-white dark:text-gray-100 px-6 py-3 rounded-md hover:bg-gray-800 transition-colors flex items-center">
      ...
      {/* Staff Table */}
      <div className="bg-white dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-800 overflow-hidden shadow-sm">
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white dark:bg-gray-950 divide-y divide-gray-200 dark:divide-gray-700">
                {filteredStaff.map((member, index) => (
                  <tr key={member.id} className={`hover:bg-gray-50 dark:bg-black transition-colors ${index % 2 === 0 ? 'bg-white dark:bg-gray-950' : 'bg-gray-25'}`}>
                    {/* Staff Details */}
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <div className="bg-gray-100 dark:bg-gray-900 dark:bg-gray-800 h-10 w-10 rounded-full flex items-center justify-center">
                          <Users className="h-5 w-5 text-gray-600 dark:text-gray-400" />
                        </div>
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900 dark:text-white">{member.name}</div>
                          <div className="text-sm text-gray-500 dark:text-gray-400">ID: {member.employeeId}</div>
                    ...
                    <td className="px-6 py-4">
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400 flex items-center mb-1">
                        <Phone className="h-4 w-4 mr-2 text-gray-600 dark:text-gray-400" />
                        {member.phone}
                      </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-2">
                        ...
                        <button className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:text-white p-2 hover:bg-gray-50 dark:bg-black dark:hover:bg-gray-900 dark:bg-gray-900 rounded-lg transition-colors">
        ...
        {filteredStaff.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">Try adjusting your search criteria or add a new staff member.</p>
          </div>
        )}
      </div>
    </div>
