  ...
  return (
    <div className="p-6 bg-gray-50 dark:bg-black min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Manage doctor profiles, specialties, and information</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Inactive Doctors</p>
      ...
      {/* Search and Filters */}
      <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-6 mb-8 border border-gray-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 flex-1">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                value={searchTerm}
      ...
      <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-black border-b border-gray-200 dark:border-gray-800">
              <tr>
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Doctor</th>
                <th className="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Specialty</th>
            ...
            <tbody className="bg-white dark:bg-gray-950 divide-y divide-gray-200 dark:divide-gray-700">
              {loading ? (
                ...
                doctors.map((doctor) => (
                  <tr key={doctor._id} className="hover:bg-gray-50 dark:bg-black dark:hover:bg-gray-900 dark:bg-gray-900">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900 dark:text-white">{doctor.fullName}</div>
        ...
        {/* Pagination */}
        {totalPages > 1 && (
          <div className="bg-white dark:bg-gray-950 px-4 py-3 border-t border-gray-200 dark:border-gray-800 sm:px-6">
            <div className="flex items-center justify-between">
              <div className="flex-1 flex justify-between sm:hidden">
                <button
                  onClick={() => handlePageChange(currentPage - 1)}
                  disabled={currentPage === 1}
                  className="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-700 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-950 hover:bg-gray-50 dark:bg-black dark:hover:bg-gray-900 dark:bg-gray-900 disabled:opacity-50"
                >
                  Previous
                </button>
                <button
                  ...
                  className="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-700 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-950 hover:bg-gray-50 dark:bg-black dark:hover:bg-gray-900 dark:bg-gray-900 disabled:opacity-50"
                >
                  Next
                </button>
              </div>
                      ...
                      <button
                        ...
                        className={`relative inline-flex items-center px-4 py-2 border text-sm font-medium ${
                          page === currentPage
                            ...
                            : 'bg-white dark:bg-gray-950 border-gray-300 dark:border-gray-700 text-gray-500 hover:bg-gray-50 dark:bg-black'
                        }`}
                      >
                        {page}
                      </button>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-950 rounded-xl max-w-md w-full p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                    formErrors.fullName ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                  }`}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                    formErrors.specialty ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                  }`}
                >
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:bg-black dark:hover:bg-gray-900 dark:bg-gray-900 transition-colors"
                >
                  Cancel
                </button>
                <button
