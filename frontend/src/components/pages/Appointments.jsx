...
const Appointments = () => {
  ...
  const AppointmentCard = ({ appointment }) => (
    <div className="bg-white dark:bg-gray-950 rounded-xl shadow-lg dark:shadow-gray-900 border border-gray-100 p-6 hover:shadow-xl dark:shadow-gray-900 transition-all duration-300">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center">
          <div className="bg-gradient-to-br from-primary-500 to-primary-600 p-3 rounded-xl shadow-lg dark:shadow-gray-900">
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center">
          <Calendar className="h-8 w-8 mr-3 text-gray-700 dark:text-gray-300" />
            ...
            <table className="w-full">
              ...
              <tbody className="bg-white dark:bg-gray-950 divide-y divide-gray-200 dark:divide-gray-700">
                {filteredAppointments.map((appointment, index) => (
                  <tr
                    key={appointment.id}
                    className={`hover:bg-gray-50 dark:bg-black transition-colors ${
                      index % 2 === 0 ? "bg-white dark:bg-gray-950" : "bg-gray-25"
                    }`}
                  >
                    {/* Patient Details */}
