...
import { medicationsAPI } from '../../services/medicationAPI'
...
const PharmacyManagement = () => {
  ...
  const fetchMedications = async () => {
    ...
    try {
      if (user?.clinicId) {
        const response = await medicationsAPI.getAll(user.clinicId, {
          search: searchTerm,
          status: statusFilter,
          sortBy: sortBy,
          ...filters
        ...
        if (response.success) {
          ...
          calculateStats(response.medications)
        } else {
          // Fallback to mock data if API fails
          console.warn('API failed, using mock data:', response.error)
          setMedications(mockMedications)
          calculateStats(mockMedications)
          toast.error(response.error || 'Failed to fetch medications')
        }
      } else {
        // Use mock data if no clinic ID
        setMedications(mockMedications)
        calculateStats(mockMedications)
      }
    } catch (error) {
  ...
  const getStatusColor = (status) => {
    const colors = {
      inStock: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
      lowStock: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400',
      outOfStock: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400',
      expiringSoon: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400',
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800/30 rounded-xl p-4 mb-6">
        <div className="flex items-center">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-[#e6f0ff] to-[#e6f7f5] dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl p-6 mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="bg-white dark:bg-gray-950/80 backdrop-blur text-gray-700 dark:text-gray-300 py-2 px-4 rounded-lg text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-900 transition-all flex items-center shadow-sm border border-gray-200 dark:border-gray-800"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-gray-800 hover:shadow-lg dark:shadow-gray-900 transition-all duration-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-semibold text-gray-900 dark:text-white">{stats.inStock}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
              ...
              <span className="text-sm font-semibold text-gray-900 dark:text-white">{stats.lowStock}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
              ...
              <span className="text-sm font-semibold text-gray-900 dark:text-white">{stats.outOfStock}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
              ...
              <span className="text-sm font-semibold text-gray-900 dark:text-white">{stats.expiringSoon}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm p-4 sm:p-6 border border-gray-100 dark:border-gray-800 hover:shadow-lg dark:shadow-gray-900 transition-all duration-200">
          ...
          <div className="space-y-2">
            ...
            >
              <AlertTriangle className="h-4 w-4 mr-3 text-[#004D99] dark:text-blue-400" />
              ...
              return (
                <div key={index} className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-gradient-to-r from-[#004D99] to-[#42A89B] rounded-full flex items-center justify-center">
                    <Pill className="h-4 w-4 text-white dark:text-gray-100" />
                  </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`px-4 py-3 border border-gray-200 dark:border-gray-800 rounded-lg transition-all flex items-center ${
                showAdvancedFilters
                  ? 'bg-[#004D99] text-white border-[#004D99] dark:bg-blue-600'
                  : 'bg-white dark:bg-gray-950 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
            ...
            <select
              className="px-4 py-3 border border-gray-200 dark:border-gray-800 rounded-lg focus:ring-2 focus:ring-[#004D99] focus:border-transparent transition-all bg-white dark:bg-gray-950 text-gray-900 dark:text-white"
              value={sortBy}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-200 dark:border-gray-800 rounded-lg focus:ring-2 focus:ring-[#004D99] focus:border-transparent transition-all bg-white dark:bg-gray-950 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
              ...
              <div>
                ...
                <select
                  className="w-full px-3 py-2 border border-gray-200 dark:border-gray-800 rounded-lg focus:ring-2 focus:ring-[#004D99] focus:border-transparent transition-all bg-white dark:bg-gray-950 text-gray-900 dark:text-white"
      ...
      <div className="bg-white dark:bg-gray-950 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden hover:shadow-lg dark:shadow-gray-900 transition-all duration-200">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700">
          <div className="flex items-center justify-between">
            ...
            <tbody className="bg-white dark:bg-gray-950 divide-y divide-gray-200 dark:divide-gray-700">
              {sortedMedications.map((medication) => {
                ...
                return (
                  <tr
                    key={medication._id}
                    className="hover:bg-gradient-to-r hover:from-blue-50 hover:to-green-50 dark:hover:from-blue-900/20 dark:hover:to-green-900/20 transition-all duration-200 border-l-4 border-transparent hover:border-[#004D99] dark:hover:border-blue-400"
                  >
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <div className="text-xs text-gray-500 dark:text-gray-400">₹{medication.price} per unit</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900 dark:text-white">{medication.category}</div>
                          <div className="text-xs text-gray-500 dark:text-gray-400">Medical Category</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900 dark:text-white">{medication.stock} units</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Min: {medication.minStock} units</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <div className="text-sm font-medium text-gray-900 dark:text-white">{medication.supplier}</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        ...
                        <button className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-200 transition-colors">
