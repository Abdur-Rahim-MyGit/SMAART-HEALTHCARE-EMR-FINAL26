    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">Manage system users and staff members</p>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody className="bg-white dark:bg-gray-950 divide-y divide-gray-200 dark:divide-gray-700">
              {filteredUsers.map((userItem) => (
                <tr key={userItem._id} className="hover:bg-gray-50 dark:hover:bg-gray-900 dark:bg-gray-900">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    {userItem.specialization && (
                      <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">{userItem.specialization}</div>
                    )}
                  </td>
