  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
        ...
        >
          <div className="h-full bg-white dark:bg-gray-950 opacity-30 animate-pulse"></div>
        </div>
      </div>
    </div>
  );
...
export const HealthcareCardSkeleton = () => {
  return (
    <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100 animate-pulse">
...
export const HealthcareTableSkeleton = ({ rows = 5 }) => {
  return (
    <div className="bg-white dark:bg-gray-950 rounded-lg shadow-sm border border-gray-100 overflow-hidden">
