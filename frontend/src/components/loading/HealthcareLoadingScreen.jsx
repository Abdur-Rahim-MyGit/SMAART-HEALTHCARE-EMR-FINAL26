    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 flex items-center justify-center">
      ...
      <div className="relative z-10 text-center max-w-md mx-auto px-6">
         ...
         <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 animate-fadeIn" style={{ animationDelay: '0.5s' }}>
        ...
        <div className="mb-8">
          ...
          <p className="text-lg font-medium text-gray-700 dark:text-gray-300 animate-fadeIn">
        ...
        <div className="mb-6">
          <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
            ...
            >
              <div className="absolute inset-0 bg-white dark:bg-gray-950 opacity-30 animate-pulse"></div>
            </div>
          </div>
