    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Spinners */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Healthcare Spinners</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                <HealthcareSpinner size="sm" color="primary" />
                <span className="text-sm text-gray-600 dark:text-gray-400">Small Primary</span>
              </div>
              <div className="flex items-center space-x-4">
                <HealthcareSpinner size="md" color="green" />
                <span className="text-sm text-gray-600 dark:text-gray-400">Medium Green</span>
              </div>
              <div className="flex items-center space-x-4">
                <HealthcareSpinner size="lg" color="red" />
                <span className="text-sm text-gray-600 dark:text-gray-400">Large Red</span>
              </div>
            </div>
          </div>
          ...
          {/* Pulse Loaders */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Pulse Loaders</h3>
            <div className="space-y-4">
          ...
          {/* Heartbeat Loader */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Heartbeat Loader</h3>
            <div className="space-y-4">
          ...
          {/* Data Sync Loader */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Data Sync Loader</h3>
            <div className="space-y-4">
          ...
          {/* Security Loader */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Security Loader</h3>
            <div className="space-y-4">
          ...
          {/* Medical Loader */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Medical Loader</h3>
            <div className="space-y-4">
          ...
          {/* Card Skeleton */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Card Skeleton</h3>
            <HealthcareCardSkeleton />
          </div>

          {/* Table Skeleton */}
          <div className="bg-white dark:bg-gray-950 rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Table Skeleton</h3>
