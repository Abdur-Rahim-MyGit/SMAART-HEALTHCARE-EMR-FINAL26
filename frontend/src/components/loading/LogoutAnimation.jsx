      ...
      <div className="relative z-10 text-center">
        ...
        <div className="relative mb-8">
          ...
          <div className="relative mx-auto w-32 h-32 mb-6">
            ...
            {showGoodbye && (
              <>
                <LogOut className="absolute -top-2 -right-2 w-6 h-6 text-gray-500 dark:text-gray-400 animate-bounce" />
                <LogOut className="absolute -bottom-2 -left-2 w-5 h-5 text-gray-500 dark:text-gray-400 animate-bounce" style={{ animationDelay: '0.3s' }} />
                <LogOut className="absolute top-2 -left-4 w-4 h-4 text-gray-500 dark:text-gray-400 animate-bounce" style={{ animationDelay: '0.6s' }} />
                <LogOut className="absolute -top-4 left-2 w-5 h-5 text-gray-500 dark:text-gray-400 animate-bounce" style={{ animationDelay: '0.9s' }} />
              </>
            )}
          </div>
          ...
          {showGoodbye && (
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <LogOut className="w-20 h-20 text-gray-500 dark:text-gray-400 animate-scale-in" />
            </div>
          )}
        </div>
        ...
        <div className="space-y-4">
          ...
          {showGoodbye && (
            <div className="flex items-center justify-center space-x-2 text-gray-500 dark:text-gray-400 animate-fadeIn">
