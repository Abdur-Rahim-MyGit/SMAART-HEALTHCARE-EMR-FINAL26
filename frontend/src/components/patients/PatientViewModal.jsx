...
const PatientViewModal = ({ isOpen, onClose, patient }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-950 rounded-xl shadow-2xl max-w-6xl w-full mx-4 max-h-[95vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border dark:border-gray-800 bg-gray-50 dark:bg-black">
          ...
          <div className="flex space-x-4">
            <div className="bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-lg text-sm">
              General Wallet:{" "}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center">
                <User className="h-5 w-5 mr-2 text-gray-500 dark:text-gray-400" /> Basic Info
              </h3>
            ...
            <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center">
                <Phone className="h-5 w-5 mr-2 text-gray-500 dark:text-gray-400" /> Contact
              </h3>
              <p>{patient.phone}</p>
            ...
            <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center">
                <MapPin className="h-5 w-5 mr-2 text-gray-500 dark:text-gray-400" /> Address
              </h3>
          ...
          {patient.categoryHistory && (
            <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
                <History className="h-5 w-5 mr-2 text-gray-500 dark:text-gray-400" /> Clinic
                Category History
              </h3>
          ...
          {patient.visits?.length > 0 && (
            <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
              <h3 className="font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
                <Calendar className="h-5 w-5 mr-2 text-gray-500 dark:text-gray-400" /> Clinic Visit
                History
              </h3>
          ...
          <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
            <h3 className="font-semibold text-gray-900 dark:text-white mb-3 flex items-center">
              <CreditCard className="h-5 w-5 mr-2 text-gray-500 dark:text-gray-400" /> Payment
              History
            </h3>
            ...
            {patient.payments?.credits?.length > 0 && (
              <>
                <h4 className="font-semibold text-gray-800 dark:text-gray-200">Credits</h4>
                <ul className="mb-4">
            ...
            {patient.payments?.debits?.length > 0 && (
              <>
                <h4 className="font-semibold text-gray-800 dark:text-gray-200">Debits</h4>
                <ul>
        ...
        {/* Footer */}
        <div className="flex justify-end p-6 border-t border-gray-200 dark:border dark:border-gray-800">
          <button
            onClick={onClose}
            className="px-6 py-2 bg-gray-600 text-white dark:text-gray-100 rounded-lg hover:bg-gray-700"
          >
            Close
          </button>
        </div>
