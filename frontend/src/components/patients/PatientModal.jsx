...
const DetailSection = ({ title, children }) => (
  <div className="mb-8">
    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 border-b-2 border-gray-200 dark:border dark:border-gray-800 pb-2 mb-4">
      {title}
    </h3>
    {children}
  </div>
        ...
        <tfoot className="bg-gray-50 dark:bg-black">
          <tr>
            <td
              ...
              className="px-4 py-3 text-right text-sm font-bold text-gray-700 dark:text-gray-300"
            >
              Total
            </td>
...
const PatientViewModal = ({ isOpen, onClose, patient }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-4">
      <div className="bg-gray-50 dark:bg-black rounded-lg shadow-2xl w-full max-w-6xl max-h-[95vh] flex flex-col">
        <div className="p-4 border-b flex justify-between items-center bg-white dark:bg-gray-950 rounded-t-lg">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={onClose}
              className="text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 dark:text-gray-300"
            >
              <X className="h-6 w-6" />
            </button>
          </div>
        ...
        <div className="p-6 overflow-y-auto">
          <nav
            className="-mb-px flex space-x-8 border-b border-gray-200 dark:border dark:border-gray-800 mb-6"
            aria-label="Tabs"
          >
            <a
              href="#"
            ...
            <a
              href="#"
              className="border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 dark:text-gray-300 hover:border-gray-300 dark:border-gray-700 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm"
            >
              Case Log
            </a>
          </nav>
          ...
          <DetailSection title="">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 text-sm">
              <div className="flex">
                <strong className="w-32 text-gray-500 dark:text-gray-400">First Name:</strong>
                <span className="text-gray-800 dark:text-gray-200">
                  {patient.fullName?.split(" ")[0]}
                </span>
              </div>
              <div className="flex">
                <strong className="w-32 text-gray-500 dark:text-gray-400">Last Name:</strong>
                <span className="text-gray-800 dark:text-gray-200">{patient.lastName}</span>
              </div>
              <div className="flex">
                <strong className="w-32 text-gray-500 dark:text-gray-400">Gender:</strong>
                <span className="text-gray-800 dark:text-gray-200 capitalize">
                  {patient.gender}
                </span>
              </div>
              <div className="flex">
                <strong className="w-32 text-gray-500 dark:text-gray-400">DOB & Age:</strong>
                <span className="text-gray-800 dark:text-gray-200">
                  {patient.dateOfBirth
                    ? `${format(
              ...
              <div className="flex">
                <strong className="w-32 text-gray-500 dark:text-gray-400">Mobile No:</strong>
                <span className="text-gray-800 dark:text-gray-200">{patient.attenderMobile}</span>
              </div>
              <div className="flex">
                <strong className="w-32 text-gray-500 dark:text-gray-400">City:</strong>
                <span className="text-gray-800 dark:text-gray-200">{patient.city}</span>
              </div>
              <div className="flex">
                <strong className="w-32 text-gray-500 dark:text-gray-400">Pincode:</strong>
                <span className="text-gray-800 dark:text-gray-200">{patient.pinCode}</span>
              </div>
            </div>
          </DetailSection>
