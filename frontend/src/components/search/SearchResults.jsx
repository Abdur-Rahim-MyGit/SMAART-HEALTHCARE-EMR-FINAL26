        ...
        <div className="w-full max-w-2xl bg-white dark:bg-gray-950 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden">
          ...
          <div className="flex items-center px-4 py-4 border-b border-gray-100 dark:border-gray-800">
            ...
            <input
              ...
              className="flex-1 outline-none text-lg placeholder-gray-400 dark:placeholder-gray-500 bg-transparent dark:text-white"
            />
            {isLoading && (
            ...
            <button
              onClick={clearSearch}
              className="ml-3 p-1 hover:bg-gray-100 dark:hover:bg-gray-800 dark:bg-gray-800 rounded-full transition-colors duration-200"
              title="Close search"
            >
              <X className="h-4 w-4 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 dark:text-gray-400" />
            </button>
          </div>
          ...
          {(searchResults.length > 0 || searchQuery) && (
            <div className="px-4 py-3 border-t border-gray-100 bg-gray-50 dark:bg-black">
              <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-1">
                    <span className="font-mono bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded px-1">↑↓</span>
                    <span>Navigate</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="font-mono bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded px-1">↵</span>
                  ...
                  <div className="flex items-center gap-1">
                    <span className="font-mono bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded px-1">esc</span>
                    <span>Close</span>
                  </div>
                </div>
